...
ADJECTIVES: list = ["breathtaking", "peaceful", "challenging", "refreshing", "unbelievable"]
ACTIONS: list = ["hiked", "explored", "camped at", "discovered", "relaxed in"]
TOPICS: list = ["a hidden trail", "a scenic overlook", "a cozy campsite", "a crystal-clear lake", "a rugged mountain path"]
...
def generate_messages():
    ...
    while True:
        ...
        yield f"I just {action} {topic}! The experience was absolutely {adjective}!"
